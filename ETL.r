...
d = read.csv("C:\\Users\\vkumar15\\Desktop\\datacsv.csv",header = TRUE)
...
result <- xmlParse(file = "C:\\Users\\vkumar15\\Desktop\\dataxml.xml")
...
xmldataframe <- xmlToDataFrame("C:\\Users\\vkumar15\\Desktop\\dataxml.xml")
